...
UTILS_DIR   = ./src/utils
UTILS_SRC   = Utils.cpp ConfigParseUtils.cpp Pipe.cpp
UTILS_OBJ   = $(addprefix $(OBJS_DIR)/, $(UTILS_SRC:.cpp=.o))

HTTP_DIR   = ./src/http
HTTP_SRC   = HttpUtils.cpp RequestParser.cpp Router.cpp Handler.cpp MultipartParser.cpp Logger.cpp
...
vpath %.cpp . $(SERVER_DIR) $(SOURCES_DIR) $(UTILS_DIR) $(CONFIG_DIR) $(HTTP_DIR) $(CGI_DIR)
